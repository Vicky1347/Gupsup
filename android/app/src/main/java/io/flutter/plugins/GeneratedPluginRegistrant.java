...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.xor_encryption.XorEncryptionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin xor_encryption, com.example.xor_encryption.XorEncryptionPlugin", e);
    }
  }
}
